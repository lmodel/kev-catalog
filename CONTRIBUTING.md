# Contributing to kev-catalog

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
kev-catalog. These guidelines are not strict rules.
...
The kev-catalog team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the kev-catalog technical leads
...
[issues]: https://github.com/lmodel/kev-catalog/issues/
[pulls]: https://github.com/lmodel/kev-catalog/pulls/
